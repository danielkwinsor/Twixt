...
public enum Direction {
    ...
    private static final int HALFWAY = NUM_DIRECTIONS / 2;
    private static final int ONE_LESS = NUM_DIRECTIONS - 1;
    
    public Direction getOpposite() {
        if (this == NULL_DIRECTION) {
            return NULL_DIRECTION;
        }
        return Direction.values()[((this.ordinal() + HALFWAY) % NUM_DIRECTIONS)];
        //switch (this) {
        //case LEFT_UP:
        //    return RIGHT_DOWN;
        //case UP_LEFT:
    ...
    public Direction rotateCounterClockwise() {
        ...
        return Direction.values()[((this.ordinal() + ONE_LESS) % NUM_DIRECTIONS)];
        //switch (this) {
        //case LEFT_UP:
        //    return LEFT_DOWN;
        //case UP_LEFT:
